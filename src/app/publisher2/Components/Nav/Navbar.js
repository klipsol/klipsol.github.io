...
export default function Navbar() {
  ...
  return (
    <div className="px-[20%] w-full opacity-0 mt-8 " id="nav">
      <div className="px-4 md:px-8 py-4 flex justify-between items-center flex-col md:flex-row bg-[#FFDF73] rounded-3xl">
