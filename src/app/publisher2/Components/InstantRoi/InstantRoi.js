        ...
        <div className="lg:h-screen sm:h-full bg-[#EEF0F8] sm:rounded-t-3xl lg:rounded-none overflow-hidden w-[50%]">
          ...
          <div className="lg:mt-[30%] sm:mt-[20%] flex flex-col w-full gap-y-10 2xl:gap-y-14 items-end text-[#505C6E]">
            <div className="flex justify-end sm:flex-col lg:flex-row lg:w-[80%] sm:w-[95%] gap-x-10 items-center 2xl:text-2xl">
              <h2 className="font-semibold self-start lg:self-auto ml-4 lg:m-auto">
                Cost
              </h2>
              <div className="min-w-[90%] sm:w-full sm:text-sm lg:text-base inline-flex items-center justify-start pl-4 h-10  2xl:py-10 2xl:rounded-l-[45px]  bg-white rounded-l-3xl  text-[#505C6E]">
                1M + per year
              </div>
            </div>
            ...
            <div className="flex sm:flex-col lg:flex-row justify-end lg:w-[80%] sm:w-[95%] gap-x-10 items-center 2xl:text-2xl">
              ...
              <div className="min-w-[90%] sm:text-sm lg:text-base sm:w-full inline-flex items-center justify-start pl-4 h-10 2xl:py-10 2xl:rounded-l-[45px] bg-white rounded-l-3xl  text-[#505C6E] ">
