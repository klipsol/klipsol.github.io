    ...
    <div className="text-black">
      ...
      <div className="max-w-3xl mx-auto p-6 border-2 border-gray-500 rounded-2xl bg-white my-10">
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>
            Flexible Tech: Adaptable layouts, from subtle links to bold banners
            in prime site positions. A lightweight JS code ensures no impact on
            site speed or metrics.
          </li>
        </ul>
