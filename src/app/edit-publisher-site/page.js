...
import { getSiteData, transformPublisherMetadata } from "../utils/editUtils";
...
export default function SiteList() {
  ...
  useEffect(() => {
    (async () => {
      const siteData = await getSiteData({ configName: "metadata" });
      const allSites = transformPublisherMetadata(siteData);
