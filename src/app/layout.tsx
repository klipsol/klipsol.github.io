...
export const metadata = {
  title:
    "BlueCurrent - plug n play white label e-commerce distribution platform",
  description:
    "BlueCurrent is a distribution platform for d2c brands, offers plug n play white label e-commerce solutions for audience monetisation of websites and mobile apps",
  keywords:
  ...
  image: "https://www.bluecurrentlabs.com/favicon.png",
  url: "https://www.bluecurrentlabs.com/",
  icons: {
    icon: "https://www.bluecurrentlabs.com/favicon.png",
  },
};
