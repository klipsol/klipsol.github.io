...
export const metadata = {
	...
	twitter: {
		...
		title: 'Everything To Transact Brands On Your Site',
		description: 'Monetize By Embedding Brands Within Your Site',
		images: ['https://imagekit.dpanda.in/publisher-banner/1731586986_image.png'],
	...
	other: {
		...
		'linkedin:image': 'https://imagekit.dpanda.in/publisher-banner/1731586986_image.png',
		...
		'whatsapp:image': 'https://imagekit.dpanda.in/publisher-banner/1731586986_image.png',

		'slack:title': 'Everything To Transact Brands On Your Site',
		'slack:description': 'Monetize By Embedding Brands Within Your Site',
		'slack:image': 'https://imagekit.dpanda.in/publisher-banner/1731586986_image.png',
	},
};
			...
			<SmoothScroll>
				...
				>
					<div className="lg:max-w-xs lg:mr-10">
						...
						<img className="m-auto max-w-[260px]" src="/money.png" alt="money" />
					</div>
						...
						<div className="relative">
							...
							<div className="relative pt-6 rounded-2xl z-10 -mt-3 flex rounded-t-none bg-[#F7BC31] p-4">
								...
								<ul className="w-1/3 lg:w-1/2 text-end lg:text-center text-sm lg:text-lg flex-1 space-y-2 lg:space-y-4">
									<li className="text-[#1D234E] text-base lg:text-xl font-bold">$1,000 - $16,000</li>
									<li className="text-base lg:text-xl font-medium text-[#1D234E]">$10 - $160</li>
								</ul>
							</div>
				...
				<section id="compounding" className="my-8 max-w-2xl m-auto">
					<div className="text-[#1D234E] text-center my-8">
						...
						<p className="lg:mt-2 text-sm">(from User Retention and First Party Data)</p>
					</div>
					...
					<div className="relative rounded-2xl mx-2 z-10 bg-[#FFFAE9] lg:divide-x-0 divide-x-[1px] divide-[#2b2d3a] flex p-4">
						<ul className="flex-1 lg:ml-4 text-sm lg:text-lg lg:text-center text-start space-y-2">
							...
							<li className="text-[#003046]">Media for Sharper Brand Cohorts</li>
							<li className="text-[#003046]">Remarketing Abandoned Users</li>
							<li className="text-[#1D234E] font-bold lg:text-xl text-base">Compounding Effect</li>
						</ul>
					...
					<div className="relative pt-6 rounded-2xl z-0 -mt-3 rounded-t-none mx-2 bg-[#F7BC31] flex p-4">
						<ul className="text-start lg:ml-4 text-sm lg:text-lg lg:text-center flex-1 space-y-2 lg:space-y-4">
							...
							<li className=" font-medium lg:text-xl">Long Term Effective CPM</li>
						</ul>
						<ul className="text-end text-sm lg:text-lg lg:text-center flex-1 space-y-7 md:space-y-2 lg:space-y-4">
							<li className="text-[#1D234E] font-bold lg:text-xl text-base">$4,300 - $69,000</li>
							<li className="text-[#1D234E] lg:text-xl font-medium">$45 - $690</li>
						</ul>
					</div>
				</section>
				...
				<section id="compounding" className="my-8 max-w-2xl m-auto">
					<div className="text-[#1D234E] text-center my-8">
						...
						<p className="lg:mt-1 text-sm">(from User Retention and First Party Data)</p>
					</div>
					...
					<div className="justify-between gap-2 md:gap-4 rounded-2xl mx-2 z-10 bg-[#FFFAE9] flex p-4">
						<div className="md:flex w-1/3 text-center rounded-2xl p-2 md:p-4 bg-[#F7BC31] font-semibold">
							<p className="md:m-auto lg:text-xl break-words text-wrap">Data Backed Acquisition</p>
						</div>
						<div className="md:flex w-1/3 text-center rounded-2xl p-2 md:p-4 bg-[#F7BC31] font-semibold">
							<p className="md:m-auto lg:text-xl break-words text-wrap">Organic User Retention</p>
						</div>
						<div className="md:flex w-1/3 text-center rounded-2xl p-2 md:p-4 text-wrap bg-[#F7BC31] font-semibold">
							<div className="md:m-auto lg:text-xl break-words text-wrap">User Remarketing</div>
						</div>
					</div>
				</section>
			</SmoothScroll>
