	...
	useEffect(() => {
		...
		switch (pathname) {
			...
			case '/publisher/pinterest':
				...
				root.style.setProperty('--brand-color', '230 0 35'); // RGB for #8a317d
				break;
			case '/publisher/myfitnesspal':
				root.style.setProperty('--primary-color', '203 223 251'); // RGB for #fff
				root.style.setProperty('--secondary-color', '0 0 0'); // RGB for #081338
				root.style.setProperty('--action-color', '0 102 238'); // RGB for #8a317d
				root.style.setProperty('--brand-color', '0 102 238'); // RGB for #8a317d
				break;
			default:
