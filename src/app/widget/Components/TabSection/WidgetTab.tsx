    ...
    <div className="text-black">
      ...
      <div className="max-w-3xl mx-auto p-6 border-2 border-gray-500 rounded-2xl bg-white my-10">
        <p className="">
          ...
          Add customizable product carousels anywhere on your page, with
          seamless scrolling for intuitive navigation.
        </p>
      ...
      <div className="max-w-3xl mx-auto p-6 border-2 border-gray-500 rounded-2xl bg-white my-10">
        ...
        <p className=" relative">
          ...
          Our adaptable widget seamlessly integrates into your layout, offering
          options like floating icons or hyperlinked shoppable texts for maximum
          flexibility. <br />
          <span
      ...
      <div className="max-w-3xl mx-auto p-6 border-2 border-gray-500 rounded-2xl bg-white my-10">
        <p className="">
          ...
          Dynamic callouts intelligently appear above the fold based on user
          scroll depth, cohort, and context, enhancing engagement
        </p>
        <FloatingCallout />
      </div>
      <div className="max-w-3xl mx-auto p-6 border-2 border-gray-500 rounded-2xl bg-white my-10">
        <div>
          <p className="">
            ...
            Embed a full-featured shopping site directly within your page using
            our shop CTA.
          </p>
        </div>
      ...
      <div className="max-w-3xl mx-auto p-6 border-2 border-gray-500 rounded-2xl bg-white my-10">
        <p>
          ...
          Our AI-powered recommendation engine identifies shoppable keywords in
          your blogs or articles and maps them to relevant products from your
          catalog, delivering unmatched precision.
        </p>
      ...
      <div className="max-w-3xl mx-auto p-6 border-2 border-gray-500 rounded-2xl bg-white my-10">
        <h4 className="text-2xl font-semibold">
          Connected Intelligence for Smarter Commerce
        </h4>
          ...
          <tbody>
            <tr className="bg-white hover:bg-gray-50 transition-colors duration-300">
              ...
              <td className="w-full gap-4 justify-center items-center text-left py-3 px-6 border border-gray-200">
                AI-powered product sync ensures real-time inventory, pricing,
                and fulfillment directly from brands.
              </td>
            </tr>
            <tr className="bg-white hover:bg-gray-50 transition-colors duration-300">
              <td className="text-left text-sm text-gray-600 py-3 px-6 border border-gray-200">
              ...
              <td className="text-left py-3 px-6 border border-gray-200">
                Persistent carts adapt to user behavior, enabling retargeting
                and optimizing engagement across sessions.
              </td>
            </tr>
            <tr className="bg-white hover:bg-gray-50 transition-colors duration-300">
              <td className="text-left text-sm text-gray-600 py-3 px-6 border border-gray-200">
              ...
              <td className="inline-flex w-full justify-center text-left py-3 px-6 border border-gray-200">
                Dynamic designs adapt to user context, from subtle links to bold
                banners, powered by lightweight, site-speed-friendly JS.
              </td>
            </tr>
            <tr className="bg-white hover:bg-gray-50 transition-colors duration-300">
              <td className="text-left text-sm text-gray-600 py-3 px-6 border border-gray-200">
            ...
            <tr className="bg-white hover:bg-gray-50 transition-colors duration-300">
              ...
              <td className="text-left py-3 px-6 border border-gray-200">
                Run time-sensitive promotions with urgency-inducing UIs like
                countdown timers and banners. Drives urgency and excitement,
            ...
            <tr className="bg-white hover:bg-gray-50 transition-colors duration-300">
              ...
              <td className="text-left py-3 px-6 border border-gray-200">
                Tailored product suggestions based on user behavior, cohort,
                page context, and brand-side intelligence. Helps users discover
                products they’ll love, enhancing satisfaction and conversions .
              </td>
            </tr>
            <tr className="bg-white hover:bg-gray-50 transition-colors duration-300">
              <td className="text-left text-sm text-gray-600 py-3 px-6 border border-gray-200">
            ...
            <tr className="bg-white hover:bg-gray-50 transition-colors duration-300">
              ...
              <td className="text-left py-3 px-6 border border-gray-200">
                Site-exclusive discounts for specific products, users, or time
                periods. Enhances loyalty and strengthens brand partnerships.
              </td>
            </tr>
            <tr className="bg-white hover:bg-gray-50 transition-colors duration-300">
              <td className="text-left text-sm text-gray-600 py-3 px-6 border border-gray-200">
              ...
              <td className="text-left py-3 px-6 border border-gray-200">
                Limited-time deal tags and dynamic visuals. Creates a sense of
                urgency and fun, encouraging impulse buys.
              </td>
            </tr>
          </tbody>
        </table>
          ...
          <table className="table-auto w-full my-4 border-collapse border border-spacing-0 rounded-lg overflow-hidden shadow-lg">
            ...
            <tbody>
              <tr className="bg-white hover:bg-gray-50 transition-colors duration-300">
                ...
                <td className="text-sm text-gray-600 py-3 px-6 border border-gray-200">
                  AI-driven personalization with intelligent layouts optimized
                  for discovery and purchase.
                </td>
              </tr>
              <tr className="bg-white hover:bg-gray-50 transition-colors duration-300">
                <td className="text-left text-sm text-gray-600 py-3 px-6 border border-gray-200">
                ...
                <td className="text-sm text-gray-600 py-3 px-6 border border-gray-200">
                  Targeted features like Price Alerts, Flash Sales, and
              ...
              <tr className="bg-white hover:bg-gray-50 transition-colors duration-300">
                ...
                <td className="text-sm text-gray-600 py-3 px-6 border border-gray-200">
                  Unlock higher revenue through multi-brand checkout, exclusive
                  site promotions, and maximized ROI.
                </td>
              </tr>
              <tr className="bg-white hover:bg-gray-50 transition-colors duration-300">
                <td className="text-left text-sm text-gray-600 py-3 px-6 border border-gray-200">
                ...
                <td className="text-sm text-gray-600 py-3 px-6 border border-gray-200">
                  Seamless integration with automated updates and AI-powered
                  insights.
                </td>
              </tr>
              <tr className="bg-white hover:bg-gray-50 transition-colors duration-300">
                ...
                <td className="text-sm text-gray-600 py-3 px-6 border border-gray-200">
                  Stronger relationships through exclusive launches and tailored
                  promotions with real-time fulfillment.
                </td>
              </tr>
              <tr className="bg-white hover:bg-gray-50 transition-colors duration-300">
                <td className="text-left text-sm text-gray-600 py-3 px-6 border border-gray-200">
                ...
                <td className="text-sm text-gray-600 py-3 px-6 border border-gray-200">
                  Turns banners, reviews, and content into intuitive, shoppable
                  experiences with seamless eCommerce.
                </td>
              </tr>
              <tr className="bg-white hover:bg-gray-50 transition-colors duration-300">
                <td className="text-left text-sm text-gray-600 py-3 px-6 border border-gray-200">
                ...
                <td className="text-sm text-gray-600 py-3 px-6 border border-gray-200">
                  Persistent carts, price alerts, and exclusive offers encourage
