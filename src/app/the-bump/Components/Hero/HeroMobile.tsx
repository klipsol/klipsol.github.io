    ...
    <div id="hero-mobile" className="block lg:hidden scrollable-component">
      ...
      <div className="text-action p-4 relative min-h-[400px] flex">
        <div>
          <h2
            className={twMerge(
              "text-action/80 text-xl leading-8",
          ...
          <p
            className={twMerge(
              "font-medium mt-5 leading-5 lg:w-full sm:w-[95%] text-action/85",
              publisher === "dpanda" && "text-primary"
            )}
          >
        ...
        <div className="top-[280px] px-4 pointer-events-auto text-sm z-30 w-full sec-container absolute  inset-0">
          <a
            ...
            className={twMerge(
              "flex flex-col shadow-xl z-[9999] cursor-pointer bg-action rounded-[46px] py-2 xxl:py-3 xxl:rounded-[50px] w-fit px-6",
