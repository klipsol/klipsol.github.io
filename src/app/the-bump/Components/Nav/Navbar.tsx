  ...
  return (
    <>
      <div
        ...
        id="nav"
      >
        <div className="flex md:pl-[10%]  justify-between items-center flex-row bg-transparent rounded-3xl relative sm:text-sm  2xl:text-lg xxl:text-2xl">
          ...
          <Dropdown
            ...
            offeringsButton="bg-[#ffffff] text-[#063750]"
            offeringsButtonIcon="border-t-[#063750]"
          />
