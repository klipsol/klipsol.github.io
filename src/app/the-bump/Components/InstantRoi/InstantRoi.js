		...
		<section className="sec-container h-fit lg:h-screen sm:pb-10 relative flex sm:px-[10px] lg:flex-row sm:flex-col-reverse  w-full">
			<div className="lg:w-[65%] md:h-[50vh] sm:w-full flex gap-x-3 mt-4 lg:mt-0">
				<div className="lg:h-screen sm:h-full bg-[#EEF0F8] sm:rounded-t-3xl lg:rounded-none overflow-hidden w-[50%]">
					...
					<div className="lg:mt-[30%] sm:mt-[20%] flex flex-col w-full gap-y-10 2xl:gap-y-14 items-end text-[#505C6E]">
						<div className="flex justify-end sm:flex-col lg:flex-row lg:w-[80%] sm:w-[95%] gap-x-10 items-center 2xl:text-2xl">
							...
							<div className="justify-center min-w-[90%] sm:w-full sm:text-sm lg:text-base inline-flex items-center pl-4 h-8  2xl:py-10 2xl:rounded-l-[45px]  bg-white rounded-l-3xl  text-[#505C6E]">
								1M+ per year
							</div>
						</div>
						...
						<div className="flex sm:flex-col lg:flex-row justify-end lg:w-[80%] sm:w-[95%] gap-x-10 items-center 2xl:text-2xl">
							...
							<div className="justify-center min-w-[90%] sm:text-sm lg:text-base sm:w-full inline-flex items-center pl-4 h-8 2xl:py-10 2xl:rounded-l-[45px] bg-white rounded-l-3xl  text-[#505C6E] ">
				...
				<div className="lg:h-screen sm:h-full bg-[#FEF4D3] sm:rounded-t-3xl lg:rounded-none overflow-hidden w-[50%]">
					{' '}
					<div className=" bg-[#FFE89B] h-[90px] text-[#234651] rounded-t-3xl sm:mt-0 lg:mt-10   items-center  subtitle font-semibold flex justify-center">
						Dpanda
					</div>
					<div className="lg:mt-[30%] sm:mt-[20%] flex flex-col w-full gap-y-10 2xl:gap-y-14 items-start text-[#505C6E]">
						<div className="flex justify-start sm:flex-col lg:flex-row w-[90%] gap-x-10 items-center">
							...
							<div className="text-center font-bold sm:text-sm lg:text-base text-[#1d234e] 2xl:py-10 2xl:rounded-r-[45px] custom-text-sm-medium h-8 justify-center inline-flex items-center   w-full bg-[#FFE89C] rounded-r-3xl   ">
								Free
							</div>
						</div>
						<div className="flex justify-start sm:flex-col lg:flex-row w-[90%] gap-x-10 items-center">
