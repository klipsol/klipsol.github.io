		...
		<section className="bg-[#FEF4D4] lg:bg-white md:py-20 py-10 md:px-10 sm:px-7">
			<div className="sec-container flex flex-col lg:flex-row md:justify-between sm:justify-start">
				...
				<div className="md:py-10 sm:py-7">
					...
					<div className="flex gap-x-2 mt-10 xxl:mt-[7%] justify-start text-primaryTextColor ">
						<div className="bg-[#FFF9E6] rounded-2xl whitespace-nowrap custom-text-sm relative 2xl:min-w-[188px] lg:w-[120px] sm:rounded-xl sm:w-fit sm:py-2">
						...
						<div className="bg-[#FFF9E6] rounded-2xl whitespace-nowrap custom-text-sm 2xl:min-w-[188px] relative h-fit lg:w-[120px] sm:rounded-xl sm:w-fit sm:py-2">
							<h1 className="absolute md:top-[-25px] sm:top-[-18px] md:text-[40px] sm:text-[28px] md:font-bold sm:font-light title left-[10px] text-[#9E8637] leading-tight">
								02
							</h1>
							<h1 className="font-medium md:text-[18px] sm:text-[16px] custom-text-sm pt-[19px] pr-[15px] pb-[10px] pl-[13px] sm:leading-[1.2] ">
						...
						<div className="bg-[#FFF9E6] rounded-2xl whitespace-nowrap custom-text-sm 2xl:min-w-[188px] relative w-fit h-fit lg:w-[120px] sm:rounded-xl sm:w-fit sm:py-2">
							<h1 className="absolute md:top-[-25px] sm:top-[-18px] md:text-[40px] sm:text-[28px] md:font-bold sm:font-light title left-[10px] text-[#9E8637] leading-tight">
								03
							</h1>
							<h1 className="font-medium md:text-[18px] sm:text-[16px] custom-text-sm pt-[19px] pr-[15px] pb-[10px] pl-[13px] sm:leading-[1.2]">
