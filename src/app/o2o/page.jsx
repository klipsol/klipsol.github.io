    ...
    <div>
        ...
        <div className="lg:sec-container grid md:grid-cols-2 gap-8 items-center">
          ...
          <div className="retail-network-inner space-y-6">
            <h1 className="text-[36px] lg:text-[54px] leading-[23px] text-[#003C63] text-4xl lg:text-5xl">
              Transform Your <br />
              <span className="text-[#FFCF3B] font-bold">
                Retail Network
              </span>{" "}
              into
              <br />a Sales Engine
            ...
            <Calendly
              className="request-demo rounded-[14px] text-[#003C63] bg-yellow-400 hover:bg-yellow-500 text-black font-semibold py-3 px-6 rounded shadow transition-all duration-300"
              text="Request Demo"
            />
          </div>
          {/* Right Side Image */}
      ...
      <section className="nationwide-main bg-yellow-400 py-16 px-4">
        <div className="max-w-[1200px] container mx-auto grid md:grid-cols-2 gap-4 items-center">
          ...
          <div className="nationwide-box-inner space-y-6">
            <h2
              className="mx-auto px-4 text-[36px] lg:text-[54px] leading-tight"
              style={{ color: "#003C63" }}
            >
              <span className="font-bold">Nationwide Reach,</span>
              <br />
            ...
            <div className="max-w-[1024px] mx-auto px-4">
              <div className="grid sm:grid-cols-2 gap-4 justify-center">
                ...
                <div className="bg-[#FFFAF2] p-6 rounded-[14px]">
                  <h3
                    className="text-[36px] font-bold leading-[42px] mb-2"
                    style={{ color: "#003C63" }}
                  >
                    Consumer Durables:
                  </h3>
                  <p className="text-gray-700">
                    ...
                    and growing across metros and Tier 2-3 towns ready to
                ...
                <div className="bg-[#FFFAF2] p-6 rounded-[14px]">
                  ...
                  <p className="text-gray-700 mt-[10px]">
                    <span className="font-bold" style={{ color: "#003C63" }}>
                      900+ 2-wheeler{" "}
                    </span>
                    dealerships equipped for in-store discovery and digital
                    checkout.
                  </p>
                </div>
              </div>
      ...
      <section className="bg-[#FFFAF2] py-16 scale-box-main">
        ...
        <div className="text-center mb-12 px-4">
          <h2 className="text-[36px] lg:text-[54px] leading-[23px] font-bold text-[#003C63] mb-4">
            {" "}
            Built for Scale.
          </h2>
          <p className="text-[20px] lg:text-[44px] font-medium text-[#003C63]">
        ...
        <ul className="max-w-[1200px] mx-auto px-4 pt-[60px] grid gap-x-[1.5rem] lg:gap-x-[1.875rem] gap-y-[4rem] lg:gap-y-[3rem] grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 list-none">
          ...
          <li className="w-full max-w-[100%] mx-auto relative bg-[#FFF4D1] pt-20 pb-6 px-4 rounded-[14px] flex flex-col items-center text-center mb-[40px]">
            ...
            <h3 className="text-[20px] lg:text-[22px] font-bold text-[#003C63] mb-2">
              Integrated NBFC Underwriting
            </h3>
            <p className="text-[#003C63] text-[16px]">
              Quick EMI approval at POS
            </p>
          </li>
          ...
          <li className="w-full max-w-[100%] mx-auto relative bg-[#FFF4D1] pt-20 pb-6 px-4 rounded-[14px] flex flex-col items-center text-center mb-[40px]">
            ...
            <p className="text-[#003C63] text-[16px]">
              Over 85% using AI-based scoring
            </p>
          </li>
          ...
          <li className="w-full max-w-[100%] mx-auto relative bg-[#FFF4D1] pt-20 pb-6 px-4 rounded-[14px] flex flex-col items-center text-center mb-[40px]">
            ...
            <p className="text-[#003C63] text-[16px]">
              Sub-2% with predictive analytics
            </p>
          </li>
        </ul>
      ...
      <section className="bg-[#FFFAF2] opacity-100 py-20 Steps-section">
        <div className="max-w-7xl mx-auto px-4 text-center">
          {/* Heading */}
          <h2 className="text-[36px] lg:text-[54px] leading-[23px] text-[#003C63] text-3xl md:text-4xl font-bold mb-2">
            How It Works
          </h2>
          <p className="text-[#003C63] text-lg mb-12">
            From Signup to Sale in 3 Simple Steps
          </p>
          {/* Steps */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Step 01 */}
            <div className="flex flex-col items-center relative">
              <p className="text-[#003C63] mt-3 font-medium pb-[90px]">
                Step 01
              </p>
              <div className="left-box1 relative bg-white rounded-2xl p-6 shadow-md w-full max-w-[280px] pt-[80px] min-h-[350px] flex flex-col justify-between">
                ...
                <div className="absolute -top-[60px] left-1/2 -translate-x-1/2 bg-[#FFCF3B] w-[200px] h-[200px] rounded-full flex items-center justify-center shadow-md">
                  <img
                    src="/integration_icon_transparent.png"
                    alt="Integration"
                    className="w-[152px] h-[152px]"
                  />
                </div>
                <h4 className="text-[32px] text-[#003C63] font-semibold mb-1 pt-[100px] mb-[2px]">
                  Integration
                </h4>
                <p className="text-[#003C63] text-sm">
                  NBFCs connect via API,
                  <br />
                  retailers via portal
                </p>
              </div>
            </div>
            {/* Step 02 */}
            <div className="flex flex-col items-center relative">
              ...
              <div className="left-box1 relative bg-white rounded-2xl p-6 shadow-md w-full max-w-[280px] pt-[80px] min-h-[350px] flex flex-col justify-between">
                ...
                <h4 className="text-[32px] text-[#003C63] font-semibold mb-2 pt-[100px] mb-[2px] leading-[35px] ">
                  Purchase <br></br>journey
                </h4>
                <p className="text-[#003C63] text-sm">
          ...
          <div className="mt-8 md:mt-16 flex flex-col lg:flex-row items-center justify-between gap-8">
            ...
            <div className="w-full lg:w-1/2 text-center lg:text-left">
              ...
              <p className="text-[#003C63] text-base mb-6">
                Join India’s most innovative lenders, retailers, & OEMs on the
                future of O2O.
              </p>
